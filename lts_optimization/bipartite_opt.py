...
# threshold = 10
# 0.8633609694 0.0 1.4 1.2087053571428572

# SNR = 10
# topNum = 16 keyLen = 256
# 0.7576729911 0.0 1.6 1.2122767857142858
# threshold = 10
# 0.7965494792 0.0 1.6 1.2744791666666666
...
# Bob: Alice + noise
modifiedCSIb1 = addNoise(np.array(modifiedCSIa1), SNR, 2)
savemat("csi_opt1_" + str(keyLen) + "_" + str(threshold) + ".mat", {'A': np.array([modifiedCSIa1, modifiedCSIb1]).T})
