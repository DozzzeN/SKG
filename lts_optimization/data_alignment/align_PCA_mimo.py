...
fileNameA = "./PCA/mi/2csiA.mat"
fileNameB = "./PCA/mi/2csiB.mat"
...
for i in range(1, dataLen, splitLen):
    ...
    for j in range(2, splitLen):
        ...
        if (csiAPart[j - 1] == csiAPart[j] and csiAPart[j - 2] == csiAPart[j - 1]) or \
                (csiBPart[j - 1] == csiBPart[j] and csiBPart[j - 2] == csiBPart[j - 1]):
            continue
