...
from algorithm import smooth, binaryTreeSort, quadTreeSort, genSample, insertNoise, binaryTreeSortPerm
...
sortMethods = [[binaryTreeSortPerm, binaryTreeSort], quadTreeSort]
sortMethod = sortMethods[0]

intvl = 5
keyLen = 128
segLen = int(math.pow(2, 3))
addNoise = False
interval_length = 4
insertRatio = 1
ratio = 1
...
# CSIa1OrigBack = CSIa1OrigBack - np.mean(CSIa1OrigBack)
# CSIb1OrigBack = CSIb1OrigBack - np.mean(CSIb1OrigBack)
# CSIe1OrigBack = CSIe1OrigBack - np.mean(CSIe1OrigBack)
# CSIn1OrigBack = CSIn1OrigBack - np.mean(CSIn1OrigBack)
# CSIa1OrigBack = dct(CSIa1OrigBack)
# CSIb1OrigBack = dct(CSIb1OrigBack)
# CSIe1OrigBack = dct(CSIe1OrigBack)
# CSIn1OrigBack = dct(CSIn1OrigBack)
...
# for staInd in range(40000, 80000, intvl * keyLen):
    ...
    a_list_number = sortMethod[1](list(sortCSIa1), interval_length)
