...
for para in paraLs:
    ...
    for staInd in range(0, dataLen - keyLen * intvl, intvl):
        print(staInd)
        ...
        np.random.seed(0)
        noiseOrig = np.random.uniform(1, 2, size=dataLen)
        ...
        CSIb2Orig = CSIb2Orig * noiseOrig

        tmpCSIa1 = CSIa1Orig[range(staInd, endInd, 1)]
        tmpCSIb1 = CSIb1Orig[range(staInd, endInd, 1)]
        tmpCSIb2 = CSIb2Orig[range(staInd, endInd, 1)]
        tmpNoise = noiseOrig[range(staInd, endInd, 1)]
        ...
        tmpCSIb2SortB = tmpCSIb2[tmpCSIa1IndP]
        ...
        for pp in range(0, keyLen, 1):
            ...
            for qq in range(0, keyLen, 1):
                ...
                epiIndClosenessLsAttack[qq] = sum(abs(epiInda1 - epiIndb2))
