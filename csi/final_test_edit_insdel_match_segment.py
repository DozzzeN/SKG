...
isShow = False
fileName = "csi_mobile_outdoor_r.mat"
rawData = loadmat(fileName)
# csv = open("evaluations/comparison_dct.csv", "a+")

CSIa1OrigRaw = rawData['testdata'][:, 0]
CSIb1OrigRaw = rawData['testdata'][:, 1]
CSIi1OrigRaw = loadmat('csi_mobile_outdoor_r.mat')['testdata'][:, 0]
...
# CSIa1Orig, CSIb1Orig, CSIe1Orig = entropyPerm(CSIa1OrigRaw[:minLen], CSIb1Orig, CSIe1Orig, dataLen, entropyThres=2)
# savemat('../data/data_NLOS_permh.mat', {'A': CSIa1Orig})
