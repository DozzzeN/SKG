...
for fileName in fileNames:
    ...
    # intvl = 5
    # keyLen = 256
    # mi (topNum=256)   0.9988932292    0.8             1.6                 1.5982291666666666
    # mi (topNum=16)    0.9967447917    0.6666666667    1.6                 1.5947916666666666

    # si (topNum=256)   0.9217247596    0.0             1.6                 1.4747596153846154
    # si (topNum=16)    0.9113084265    0.0             1.597295673076923   1.4556290064102564

    # mo (topNum=256)   0.9912109375    0.2             1.6                 1.5859375
    # mo (topNum=16)    0.9912109375    0.2             1.6                 1.5859375

    # so (topNum=256)   0.9775965074    0.0             1.6                 1.5641544117647057
    # so (topNum=16)    0.9260074108    0.0             1.5875              1.4700367647058825
