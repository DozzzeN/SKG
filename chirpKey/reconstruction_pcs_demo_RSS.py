...
for f in fileName:
    ...
    for staInd in range(0, len(CSIa1Orig), dataLen):
    ...
    print("bit generation rate", round(correctSum2 / len(CSIa1Orig) / times, 10))
    # print(epsilon_AB1)
    # print(epsilon_AE1)
    ...
    print("bit generation rate", round(correctSum2 / len(CSIa1Orig), 10))
    print("bit generation rate", round(correctSum2 / len(delta_AB) / times, 10))
    # print(epsilon_AB2)
    # print(epsilon_AE2)