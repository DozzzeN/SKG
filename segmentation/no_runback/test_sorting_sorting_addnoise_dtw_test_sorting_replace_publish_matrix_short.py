    ...
    for f in fileName:
        for addNoise in addNoises:
            for withoutSort in withoutSorts:
                ...
                print("entropy before", np.mean(entropy_before), "entropy after", np.mean(entropy_after))
                print("entropy before", np.var(entropy_before), "entropy after", np.var(entropy_after))
