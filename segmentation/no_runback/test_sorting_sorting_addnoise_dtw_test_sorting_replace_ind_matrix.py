                ...
                #     staInd += keyLenLoop
                    ...
                    if segment_option == "find_search":
                        ...
                        tmpCSIa1IndReshape, modifications = replace_segments_position_compared_with_all_segments_no_limit(
                            tmpCSIa1IndReshape, segLen * 2, staInd + 100000)
                        ...
                        tmpCSIb1IndReshape, _ = replace_segments_position_compared_with_all_segments_no_limit(
                            tmpCSIb1IndReshape, segLen * 2, staInd + 100000)
                        tmpCSIe1IndReshape, _ = replace_segments_position_compared_with_all_segments_no_limit(
                            tmpCSIe1IndReshape, segLen * 2, staInd + 100000)
                        ...
                        if withIndexValue:
                            ...
                            tmpCSIb1IndTmp = np.vstack(tmpCSIb1IndReshape)
                            tmpCSIe1IndTmp = np.vstack(tmpCSIe1IndReshape)
                        else:
                            tmpCSIa1IndTmp = np.hstack((tmpCSIa1IndReshape))
                            tmpCSIb1IndTmp = np.hstack((tmpCSIb1IndReshape))
                            tmpCSIe1IndTmp = np.hstack((tmpCSIe1IndReshape))
