...
from segmentation.methods import find_opt_segment_method, segment_sequence, compute_min_dtw, \
    ...
    replace_segments_position_compared_with_all_segments_no_limit_pair
        ...
        for withoutSort in withoutSorts:
            ...
            while staInd < dataLenLoop:
                ...
                if addNoise == "add" and isRunBack is False:
                    ...
                    tmpCSIe1s = []
                    for i in range(trials):
                        tmpCSIa1s.append(np.matmul(tmpCSIa1, randomMatrices[i]))
                        tmpCSIb1s.append(np.matmul(tmpCSIb1, randomMatrices[i]))
                        tmpCSIe1s.append(np.matmul(tmpCSIe1, randomMatrices[i]))
                    ...
                    for i in range(trials):
                        ...
                        if withIndexValue:
                            segment_method_ori_tmp = find_sub_opt_segment_method_sliding(
                                tmpCSIa1Inds[i], simCSIa1Inds[i], 3, 5)
                        else:
                        ...
                        tmpCSIa1IndReshapeTmp, modifications = replace_segments_position_compared_with_all_segments_no_limit_pair(
                            tmpCSIa1IndReshapeTmp, simCSIa1IndReshapeTmp, segLen * 2, staInd + 100000)
