...
# mi1 (extended) 0.9108072917 0.0 0.15824447535156855 0.14413022201617473
# si1 (extended) 0.8357543945 0.0 0.16302487562189055 0.13624875621890548
# mo1 (extended) 0.9108072917 0.0 0.15824447535156855 0.14413022201617473
# so1 (extended) 0.9189453125 0.0 0.16302487562189055 0.14981094527363184
# average BMR: 1-(0.9108072917+0.8357543945+0.9108072917+0.9189453125)/4=0.10592142739999999
# average BGR: (0.14413022201617473+0.13624875621890548+0.14413022201617473+0.14981094527363184)/4=0.1435800363812217
# csi mi1r      0.8839285714 0.0 0.1492245237847403  0.13190382013115437
# csi si1r      0.8232421875 0.0 0.11314917127071823 0.09314917127071823
# csi mor       0.9332682292 0.0 0.12654994850669413 0.11810504634397528
# csi sor       0.8790283203 0.0 0.16589712434183881 0.1458282705548805
...
keyLen = int(1026 * 2 * 3)  # 保证生成的密钥是1024位
# keyLen = 128
...
for staInd in range(0, int(dataLen), keyLen):
    CSIa1Orig = np.tile(rawData['testdata'][:, 0], 5)[0: dataLen]
    CSIb1Orig = np.tile(rawData['testdata'][:, 1], 5)[0: dataLen]
