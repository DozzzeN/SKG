...
for staInd in range(0, int(dataLen), keyLen):
    ...
    while True:
        ...
        tmpCSIa1Ind = sorted(tmpCSIa1)
        tmpCSIb1Ind = sorted(tmpCSIb1)
        tmpCSIe1Ind = sorted(tmpCSIe1)
        tmpCSIe2Ind = sorted(tmpCSIe2)
        tmpCSIn1Ind = sorted(tmpNoise1)
        tmpCSIn2Ind = sorted(tmpNoise2)
        tmpCSIn3Ind = sorted(tmpNoise3)
        tmpCSIn4Ind = sorted(tmpNoise4)
