...
# fileName = ["../csi/csi_mobile_outdoor_r",
#             "../csi/csi_mobile_indoor_1_r",
#             "../csi/csi_static_outdoor_r",
#             "../csi/csi_static_indoor_1_r"]

fileName = ["../csi/csi_mobile_indoor_r",
            "../csi/csi_static_outdoor_r",
            "../csi/csi_static_indoor_r"]
...
for f in fileName:
    ...
    for staInd in range(0, dataLen, keyLen):
        ...
        CSIa1Orig = rawData['testdata'][:, 0][0: dataLen]
        CSIb1Orig = rawData['testdata'][:, 1][0: dataLen]
        ...
        if addNoise == "add":
            ...
            tmpCSIa2 = np.matmul(tmpCSIa2, randomMatrix)
            ...
            tmpCSIa2 = tmpCSIa2 - randomMatrix.sum(axis=0) * m  # 等于tmpCSIa1
            # inference attack
        ...
        overhead += (end - start) / 5
        # print("time1:", (end - start) / 5)
        ...
        tmpCSIa1Ind = tmpCSIa1Ind[0:int(keyLen / segLen) * segLen]
        tmpCSIb1Ind = tmpCSIb1Ind[0:int(keyLen / segLen) * segLen]
        ...
        for i in range(int(keyLen / segLen)):
            ...
            for j in range(int(keyLen / segLen)):
                ...
                if metrics == "dtw":
                    # 仅计算一个dtw为例
                    # epiIndClosenessLsb[j] = accelerated_dtw(epiIndb1, epiInda1, dist=dist)[0]
                    # epiIndClosenessLse1[j] = 0
                    # epiIndClosenessLse2[j] = 0
                    # epiIndClosenessLsn1[j] = 0
                    # epiIndClosenessLsn2[j] = 0
                    # epiIndClosenessLsn3[j] = 0
                    # epiIndClosenessLsn4[j] = 0

                    # 全部计算dtw速度太慢
                    epiIndClosenessLsb[j] = accelerated_dtw(epiIndb1, epiInda1, dist=dist)[0]
                    epiIndClosenessLse1[j] = accelerated_dtw(epiInde1, epiInda1, dist=dist)[0]
                    epiIndClosenessLse2[j] = accelerated_dtw(epiInde2, epiInda1, dist=dist)[0]
                    epiIndClosenessLsn1[j] = accelerated_dtw(epiIndn1, epiInda1, dist=dist)[0]
                    epiIndClosenessLsn2[j] = accelerated_dtw(epiIndn2, epiInda1, dist=dist)[0]
                    epiIndClosenessLsn3[j] = accelerated_dtw(epiIndn3, epiInda1, dist=dist)[0]
                    epiIndClosenessLsn4[j] = accelerated_dtw(epiIndn4, epiInda1, dist=dist)[0]
                elif metrics == "city":
                    # cityblock度量
                    ...
                    epiIndClosenessLsb[j] = distance.euclidean(epiIndb1, epiInda1)
                    epiIndClosenessLse1[j] = distance.euclidean(epiInde1, epiInda1)
                    epiIndClosenessLse2[j] = distance.euclidean(epiInde2, epiInda1)
                    epiIndClosenessLsn1[j] = distance.euclidean(epiIndn1, epiInda1)
                    epiIndClosenessLsn2[j] = distance.euclidean(epiIndn2, epiInda1)
                    epiIndClosenessLsn3[j] = distance.euclidean(epiIndn3, epiInda1)
                    epiIndClosenessLsn4[j] = distance.euclidean(epiIndn4, epiInda1)
                elif metrics == "cosine":
                    epiIndClosenessLsb[j] = distance.cosine(epiIndb1, epiInda1)
                    epiIndClosenessLse1[j] = distance.cosine(epiInde1, epiInda1)
                    epiIndClosenessLse2[j] = distance.cosine(epiInde2, epiInda1)
                    epiIndClosenessLsn1[j] = distance.cosine(epiIndn1, epiInda1)
                    epiIndClosenessLsn2[j] = distance.cosine(epiIndn2, epiInda1)
                    epiIndClosenessLsn3[j] = distance.cosine(epiIndn3, epiInda1)
                    epiIndClosenessLsn4[j] = distance.cosine(epiIndn4, epiInda1)
                elif metrics == "corr":
                    epiIndClosenessLsb[j] = distance.correlation(epiIndb1, epiInda1)
                    epiIndClosenessLse1[j] = distance.correlation(epiInde1, epiInda1)
                    epiIndClosenessLse2[j] = distance.correlation(epiInde2, epiInda1)
                    epiIndClosenessLsn1[j] = distance.correlation(epiIndn1, epiInda1)
                    epiIndClosenessLsn2[j] = distance.correlation(epiIndn2, epiInda1)
                    epiIndClosenessLsn3[j] = distance.correlation(epiIndn3, epiInda1)
                    epiIndClosenessLsn4[j] = distance.correlation(epiIndn4, epiInda1)
                elif metrics == "canberra":
                    epiIndClosenessLsb[j] = distance.canberra(epiIndb1, epiInda1)
                    epiIndClosenessLse1[j] = distance.canberra(epiInde1, epiInda1)
                    epiIndClosenessLse2[j] = distance.canberra(epiInde2, epiInda1)
                    epiIndClosenessLsn1[j] = distance.canberra(epiIndn1, epiInda1)
                    epiIndClosenessLsn2[j] = distance.canberra(epiIndn2, epiInda1)
                    epiIndClosenessLsn3[j] = distance.canberra(epiIndn3, epiInda1)
                    epiIndClosenessLsn4[j] = distance.canberra(epiIndn4, epiInda1)
                elif metrics == "braycurtis":
                    epiIndClosenessLsb[j] = distance.braycurtis(epiIndb1, epiInda1)
                    epiIndClosenessLse1[j] = distance.braycurtis(epiInde1, epiInda1)
                    epiIndClosenessLse2[j] = distance.braycurtis(epiInde2, epiInda1)
                    epiIndClosenessLsn1[j] = distance.braycurtis(epiIndn1, epiInda1)
                    epiIndClosenessLsn2[j] = distance.braycurtis(epiIndn2, epiInda1)
                    epiIndClosenessLsn3[j] = distance.braycurtis(epiIndn3, epiInda1)
                    epiIndClosenessLsn4[j] = distance.braycurtis(epiIndn4, epiInda1)
        ...
        end2 = time.time()
        overhead2 += (end2 - end) / 7
        # print("time2:", (end2 - end) / 7)

        # if data are already sorted, the bisect module provides a binary search algorithm for lists
        # epiVala1 = []
        # epiValb1 = []
        # for i in range(int(keyLen / segLen)):
        #     epiVala1.append(sum(tmpCSIa1Ind[i * segLen: (i + 1) * segLen]))
        #     epiValb1.append(sum(tmpCSIb1Ind[i * segLen: (i + 1) * segLen]))
        # epiDictb1 = dict(zip(epiValb1, list(range(len(epiValb1)))))
        # sortDictb1 = sorted(epiDictb1.items(), key=lambda _: _[0])
        # dictValb1 = list(sorted(epiDictb1.keys()))
        # b_key = []
        # for i in range(int(keyLen / segLen)):
        #     pos = 0 if bisect.bisect(dictValb1, epiVala1[i]) == 0 else bisect.bisect(dictValb1, epiVala1[i]) - 1
        #     b_key.append(epiDictb1[dictValb1[pos]])

        a_list_number = list(permutation)
        b_list_number = list(minEpiIndClosenessLsb)
        # b_list_number = list(b_key)
    ...
    print("a-n4 key agreement rate", noiseWholeSum4, "/", originWholeSum, "=",
          round(noiseWholeSum4 / originWholeSum, 10))
    ...
    print(overhead2 / originWholeSum)
    print("times", times)
