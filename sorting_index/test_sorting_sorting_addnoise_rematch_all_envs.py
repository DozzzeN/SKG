...
for f in fileName:
    ...
    corrMatName = "corr_" + spiltFileName[1][0] + spiltFileName[2][0] + str(roBits) + ".mat"
    rssMatName = "corr_" + spiltFileName[1][0] + spiltFileName[2][0] + str(roBits) + "_rss.mat"
    ...
    # CSIe2Orig = np.array(CSIe2Orig)[np.random.permutation(len(CSIe2Orig))]
