        ...
        for reuse in range(reuseTimes):
            ...
            if addNoise == "mul":
                ...
                if reuse > 0:
                    ...
                    # print(np.var(tmpCSIb1))
                    # print(np.var(tmpCSIb1) / np.var(np.random.uniform(-erange, erange, keyLen)))
                    # print(10 * np.log10(np.var(tmpCSIb1) / np.var(np.random.uniform(-erange, erange, keyLen))))
                    tmpCSIb1 = tmpCSIb1 + np.random.uniform(0, erange, keyLen)
                    # print(np.var(np.random.uniform(0, erange, keyLen)))
                    # print(np.var(tmpCSIb1))
                    # exit()
