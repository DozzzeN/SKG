...
isShow = False
CSIa1OrigRaw = loadmat("predictable/CSI1.mat")['CSI1'][:, 0]
CSIb1OrigRaw = CSIa1OrigRaw + np.random.normal(0, 0.01, len(CSIa1OrigRaw))
CSIi1OrigRaw = loadmat('../data/data_static_indoor_1.mat')['A'][:, 0]
